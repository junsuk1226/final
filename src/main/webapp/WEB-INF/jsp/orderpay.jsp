        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <body>
                    ...
                    <div class="paybox">
                        <button type="button" class="paybutton" id="naverpay">네이버 결제하기</button>
                        <button type="button" class="paybutton" id="kakaopay" onclick="location.href='/kakao/pay'">카카오 결제하기</button>
                        <button type="button" class="paybutton" id="tospay">토스 결제하기</button>
