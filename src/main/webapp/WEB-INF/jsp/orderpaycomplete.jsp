        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <title>내 손안에 휴게소-마이휴 결제완료 페이지</title>
                    <style>
                        .paybox{
                            width: 100%;
                            margin: 0 auto;
                ...
                <body>
                    ...
                    <!---------------------------------결제 영역 ------------------------------------->
                    <div class="paybox">
                        주문 번호: 값 주세요(휴게소별 번호 다르게, 999번 초기화) 크게</br>
                        주문 일시: 값 주세요(날짜 시간)모두 db에서 뽑아
                    </div></br>

                    <div class="paybox">
                        휴게소: 값 주세요 휴게소</br>
                        상품 이름: 값 주세요 1 / 수량: 값 주세요 1</br>
                        상품 이름: 값 주세요 2 / 수량: 값 주세요 2</br>
                    </div></br>

                    <div class="paybox">
                        <button type="button" class="paybutton" id="btnok" onclick="location.href='/main'">확인</button>
                        <button type="button" class="paybutton" id="btndetail">주문상세보기</button>
                    </div></br>
                    <!---------------------------------결제 영역 끝------------------------------------->
                    <script>
